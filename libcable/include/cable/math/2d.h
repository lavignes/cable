...
static inline Cbl2d cbl2dDot(Cbl2d lhs, Cbl2d rhs) {
    const Cbl2d mul = cbl2dMul(lhs, rhs);
    return cbl2dAdd(cbl2dSplatX(mul), cbl2dSplatY(mul));
}

static inline Cbl2d cbl2dLength(Cbl2d v2d) {
    return cbl2dSqrt(cbl2dDot(v2d, v2d));
}

static inline Cbl2d cbl2dLengthFast(Cbl2d v2d) {
    return cbl2dSqrtFast(cbl2dDot(v2d, v2d));
}

static inline Cbl2d cbl2dSquareLength(Cbl2d v2d) {
    return cbl2dDot(v2d, v2d);
}

static inline Cbl2d cbl2dNormalize(Cbl2d v2d) {
